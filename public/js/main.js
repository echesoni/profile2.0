jQuery(document).ready(function($){
	...
	function triggerAnimation(newSection, bool) {
		isAnimating =  true;
		newSection = ( newSection == '' ) ? 'about' : newSection;
    console.log('newSection:', newSection);

		//update dashboard
    console.log('dashboard', dashboard);
    var foundDashboard = dashboard.find('*[data-menu="'+newSection+'"]').siblings();
    console.log("found: ", foundDashboard);
		dashboard.find('*[data-menu="'+newSection+'"]').addClass('selected').siblings('.selected').removeClass('selected');
